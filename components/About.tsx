  ...
  return (
    ...
    >
      ...
      <p className="font-normal">
        I am Ahmar, a <span className="font-medium">front end web developer</span>{" "} with a knack for building responsive, 
        ...
        I am always eager to explore new technologies and thrive on learning how to make web applications more
